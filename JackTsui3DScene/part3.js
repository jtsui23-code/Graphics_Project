...
function init()
{
    ...
    var maceHead = drawIcosahedron(true)
    var s = 0.5
...
function drawCube(mace=false) {
    ...
    if (!mace) {
        ...
        var faceColors = [
            vec4(0.71, 0.54, 0.38, 1.0),  // light brown
            vec4(0.71, 0.54, 0.38, 1.0),  // light brown
            vec4(0.71, 0.54, 0.38, 1.0),  // light brown
            vec4(0.71, 0.54, 0.38, 1.0),  // light brown
            vec4(0.71, 0.54, 0.38, 1.0),  // light brown
...
function drawIcosahedron(mace=false) {
    var positions = [];
    var colors = [];
    ...
    if (!mace) {
        ...
        var faceColors = [
        vec4(0.0, 0.0, 0.0, 1.0), vec4(0.0, 0.0, 0.0, 1.0), vec4(0.0, 0.0, 0.0, 1.0),
        vec4(0.0, 0.0, 0.0, 1.0), vec4(0.0, 0.0, 0.0, 1.0), vec4(0.0, 0.0, 0.0, 1.0),
        vec4(0.0, 0.0, 0.0, 1.0), vec4(0.0, 0.0, 0.0, 1.0), vec4(0.0, 0.0, 0.0, 1.0),
        vec4(0.0, 0.0, 0.0, 1.0), vec4(0.0, 0.0, 0.0, 1.0), vec4(0.0, 0.0, 0.0, 1.0),
        vec4(0.0, 0.0, 0.0, 1.0), vec4(0.0, 0.0, 0.0, 1.0), vec4(0.0, 0.0, 0.0, 1.0),
